...
* File Name:   main.c
*
* Description: PPCA Core 1 application for the Hibernate GPIO wakeup example.
*              Toggles LED2 every 200 ms while the main CM33 core manages
...
********************************************************************************
* Summary:
* This is the main function for PPCA Core 1. Toggles LED2 every 200 ms
...
* variants that do not have LED2 connected to this core.
*
* Parameters:
*  void
*
...
int main(void)
{
     for(;;)
     {
         /* Toggle LED2 every 200 ms.  The conditional compilation guard
            prevents the LED toggle on kit variants that do not have LED2
